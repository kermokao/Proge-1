...
class Zoo:
    ...
    def can_add_animal(self, animal: Animal) -> bool:
        ...
        """
        if len(self.zoo_overview) >= self.max_number_of_animals:
            return False

        if animal in self.zoo_overview:
            return False

        for animal1 in self.zoo_overview:
            if animal1.name == animal.name and animal1.species == animal.species:
                return False
    ...
    def add_animal(self, animal: Animal):
        ...
        if self.can_add_animal(animal):
            self.zoo_overview.append(animal)
    ...
    def remove_animal(self, animal: Animal):
        ...
        if self.can_remove_animal(animal):
            self.zoo_overview.remove(animal)
    ...
    def get_animals_by_age(self):
        ...
        """
        return sorted(self.zoo_overview, key=lambda animal: animal.age)
    ...
    def get_animals_sorted_alphabetically(self):
        ...
        """
        return sorted(self.zoo_overview, key=lambda animal: animal.name)
