...
class Store:
    ...
    def can_add_book(self, book: Book) -> bool:
        ...
        for existing_book in self.overview:
    ...
    def get_books_by_price(self) -> list:
        ...
        :return: list of Book objects
        """
        return sorted(self.overview, key=lambda book: book.price)
    ...
    def get_most_popular_book(self) -> list:
        ...
        :return: list of Book objects
        """
        highest_rating = max(book.rating for book in self.overview)
        return [book for book in self.overview if book.rating == highest_rating]
